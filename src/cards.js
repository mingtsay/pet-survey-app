const cards = [
  {
    name: 'description',
    text: [
      '我們是致理科技大學企業管理學系一年級的學生，此問卷為創新與創業精神專題報告的一部份。',
      '我們在此專題中規劃了寵物科技產品「Love Collar」，透過讓貓、狗配戴頸圈的方式並結合手機 App 即可查看毛小孩的健康狀況、定位等相關資訊。',
      '我們希望透過問卷調查來瞭解此產品市場接受度，您需要花費大約 5 至 10 分鐘的時間填寫問卷。',
    ].join(''),
    type: 'typography',
  },
  {
